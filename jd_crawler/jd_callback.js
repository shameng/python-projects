...
/* jdf-1.0.0/ base.js Date:2018-01-23 10:27:31 */
if (!function (a, b) {
        function c(a) {
            return function (b) {
    ...
    var seajsConfig = {base: pageConfig.jdfBaseUri, alias: {}, map: [], preload: preloadArray, debug: 0};
...
if (pageConfig.wideVersion = function () {
    ...
    }(), pageConfig.wideVersion && (document.getElementsByTagName("html")[0].className = "root61"), pageConfig.FN_getDomain = function () {
...
/* jdf-1.0.0/ ui.js Date:2018-01-23 10:27:30 */
!function () {
